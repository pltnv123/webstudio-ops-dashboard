...
function commercialHomeHero() {
  return `<section class="card span-12 commercial-home-hero" data-marker="webstudio-commercial-polish-v48 Lead Capture Order Builder Package Generator Page Builder Demo Assembly Handoff Premium Website AI Intake Bot Business Automation">
    <div class="commercial-hero-copy"><p class="eyebrow">WebStudio public product dashboard</p><h2>From lead to demo handoff — without risky live writes.</h2><p>WebStudio packages a client request into a clear commercial journey: safe intake, order shaping, package generation, page builder, demo assembly, and owner/client handoff. This public surface is static, sanitized, and approval-gated for any real integration.</p>${commercialBadgeBar()}</div>
    <div class="commercial-cta-grid">${[
      ['Start demo order','/lead-capture-demo/'],['View generated demo site','/generated-demo-site-v35/'],['View pricing packages','/pricing-packages/'],['View route health','/route-health/']
