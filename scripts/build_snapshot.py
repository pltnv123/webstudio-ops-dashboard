...
def copy_static(dist: Path, state: dict[str, Any] | None = None) -> None:
    ...
    for route_name in ["operator", "orders", "kanban", "production", "agent-workflow", "bot-activity", "approvals", "health", "route-health", "owner-morning-report", "artifacts", "marathon", "owner-feedback", "real-assets", "proposal-quote", "integration-plan", "lead-capture-demo", "client-portal-preview", "delivery-timeline", "work-factory", "owner-command-center", "supabase-memory", "sales-pack", "premium-factory", "audit"]:
