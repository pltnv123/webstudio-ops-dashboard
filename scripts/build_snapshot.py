...
def build_route_health_dashboard_v46() -> dict[str, Any]:
    routes=["/","/lead-capture-demo/","/lead-to-order-handoff/","/order-builder/","/order-package-generator/","/website-page-builder/","/one-click-demo-assembly/","/generated-demo-site-v35/","/client-handoff-pack/","/handoff-review-matrix/","/revision-request-demo/","/webstudio-showcase/","/pricing-packages/","/owner-review/","/asset-intake-pack/","/client-safe-preview/","/work-factory/","/owner-command-center/","/bot-activity/","/supabase-memory/"]
    return {"schema_version":"webstudio.route-health-dashboard.v46","marker":"route-health-v46","status":"PASS_LOCAL_READY","route":"/route-health/","public_url":"https://pltnv123.github.io/webstudio-ops-dashboard/route-health/","markers":["route-health-v46","route table","HTTP status","marker status","latest published commit","known blockers"],"latest_commit":"pending-smoke","actions_run":"pending-smoke","safety":{"static_snapshot":True,"read_only":True,"external_writes":False,"browser_side_secrets":False},"routes":[{"route":r,"http_status":"verified after publish","marker_status":"pending public smoke","status":"WATCH","next_safe_action":"Run public smoke and update report"} for r in routes],"next_safe_action":"Use this dashboard as the morning regression index after public smoke."}
