...
assert state['delivery_handoff_composer_v33']['schema_version'] == 'webstudio.delivery-handoff-composer.v39'
assert state['delivery_handoff_composer_v33']['feature'] == 'delivery_owner_signoff_packet_v39'
