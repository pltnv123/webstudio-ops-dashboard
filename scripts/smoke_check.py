...
for direct in ['/client-data-room/','/real-client-onboarding/','/client-portal-preview/','/client-safe-preview/','/proposal-quote/','/delivery-timeline/','/proof-case-study/','/integration-plan/','/route-health/']:
    assert direct in html or direct in app, f'missing direct route link {direct}'
print('SMOKE PASS')
print('routes=real-client-onboarding,client-data-room,client-portal-preview,client-safe-preview,proposal-quote,delivery-timeline,proof-case-study,integration-plan,route-health')
