...
assert state['delivery_handoff_composer_v33']['schema_version'] == 'webstudio.delivery-handoff-composer.v44'
assert state['delivery_handoff_composer_v33']['feature'] == 'handoff_rehearsal_checklist_v44'
